...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users_product', '0011_auto_20210716_2141'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_orders', to='users_product.customer', verbose_name='Покупатель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customer', to='users_product.Order', verbose_name='Заказы покупателя'),
        ),
    ]
