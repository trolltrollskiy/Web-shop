...
class Product(models.Model):
    ...
    discount = models.CharField(max_length=255, verbose_name='Кредитная карта', null=True, blank=True)
    supplier = models.CharField(max_length=255, verbose_name='Поставщик товара', null=True, blank=True)
...
class Smartphone(Product):
    ...
    #Сделать выпадающий список для выбора
