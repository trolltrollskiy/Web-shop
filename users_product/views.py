...
from .models import Laptop, Smartphone, Category, LatestProduct, Customer, Cart, CartProduct, Comment
from .mixins import CategoryDetailMixin, CartMixin
from .forms import OrderForm, CommentForm
from .utils import recalc_cart, create_comments_tree
from users.models import User


def comment_view(request, *args, **kwargs):
    comments = Smartphone.objects.first().comments.all()
...
class BaseView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        products = LatestProduct.objects.get_products_for_main_page('laptop', 'smartphone')
        context = {
